...
public class UnitCommand extends AbstractCommand {
    ...
    public String getHelp() {
        return "Returns the units in which you may gift ION in and may see your current balance value in.";
    }

    @Override
    public Command getCommand() {
        return (invoker, arguments, channel) -> {
            StringBuilder builder = new StringBuilder("The units in which you may gift ION in and may see your current balance value in.\n```\n");
